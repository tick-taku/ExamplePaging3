...
import com.tick.taku.example.paging3.databinding.ActivityCatBinding
...
class CatActivity : AppCompatActivity() {
    ...
    private val binding: ActivityCatBinding by lazy {
        DataBindingUtil.setContentView(this, R.layout.activity_cat)
    }
